...
public class FileController {
    ...
    public Result uploadTestDocument() {
        try {
            ...
            return redirect(com.itextpdf.controllers.routes.FileController.signPage(file.getId()));
    ...
    public Result upload() throws IOException {
        ...
        return redirect(com.itextpdf.controllers.routes.FileController.signPage(uplFile.getId()));
    ...
    public Result signPage(String aFileId) {
        try {
            ...
            return ok(com.itextpdf.views.html.signing.render(fileToSign.getFileName(), ndiId, aFileId));
        } catch (FileNotFoundException nfe) {

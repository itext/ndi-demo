...
public class NDIApiClientTest {
    ...
    public void configure() {
        ...
        INDIInstanceConfig               config         = new NDIInstanceConfig("DYB0SbZaCKaBa641Lh4aoP05e1u3yBCa",
                                                                                "1ySIFt3KYWCutbF16JBwEqT9KGsTgNLHQosxWhoe0QzS0tTtEzJ3YqauKk0bWlZh",
                                                                                "src/test/resources/staging.jks", "123456");
        ...
        NDIApiClient ndiClient = new NDIApiClient(config, tokenGenerator, httpClient);
        ndiClient.init();
